...
// INTERIM: still the drill-down view inside the accept flow and ReviewOrder
// (both migrate in the orders vertical). Editing moved to /donations/[id]/edit —
// the edit-mode fork that used to live here is gone.
                    ...
                    <div className="content--container">
                        ...
                        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ marginBottom: '1em' }}>
                            <Button
                                ...
                                startIcon={<EditIcon />}
                                component={Link}
                                href={`/donations/${donationDetails.id}/edit`}
                            >
                                Edit Donation
                            </Button>
